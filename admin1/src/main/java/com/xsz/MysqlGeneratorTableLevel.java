 ...
 * @version: 1.0
 */
public class MysqlGeneratorTableLevel {
    ...
    public static void main(String[] args) {
        ...
        String dataBaseUrl = "jdbc:mysql://localhost:3306/db_admin1?useUnicode=true&useSSL=false&characterEncoding=utf8";
        String userName = "root";
        String password = "XSZ202006a";
//        String tablePrefix = "tb_";// 数据库表前缀 例:tb_user的"tb_" 没有则改为 = null即可
        String tablePrefix = "";// 表级别，不需要这个属性
        String parentPackageName = "com.xsz";// 父包名
        String moduleName = "order2";// 项目模块名
    ...
    public static void excuteGeneratorCode(String driver, String dataBaseUrl, String userName, String password,
        ...
        gc.setOutputDir(projectPath + "/admin1/src/main/java");
...
//        String templatePath = "/templates/mapper.xml.ftl";
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/admin1/src/main/resources/mapper/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
            }
        });
