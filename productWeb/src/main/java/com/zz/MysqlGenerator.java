...
public class MysqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        String dataBaseUrl = "jdbc:mysql://47.92.0.22:3306/jeeplus_ani_big?useUnicode=true&useSSL=false&characterEncoding=utf8";
        ...
        String moduleName = "product";// 项目模块名
    ...
    public static void excuteGeneratorCode(String driver, String dataBaseUrl, String userName, String password,
        ...
        gc.setOutputDir(projectPath + "/productcore3/src/main/java");
...
//        String templatePath = "/templates/mapper.xml.ftl";
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/productcore3/src/main/resources/mapper/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
            }
        });
