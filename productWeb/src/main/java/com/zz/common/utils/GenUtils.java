...
import com.zz.common.config.Constant;
import com.zz.common.domain.ColumnDO;
import com.zz.common.domain.TableDO;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        map.put("datetime", com.zz.common.utils.DateUtils.format(new Date(), com.zz.common.utils.DateUtils.DATE_TIME_PATTERN));
        ...
        for (String template : templates) {
            ...
            try {
                ...
                throw new com.zz.common.utils.BDException("渲染模板失败，表名：" + tableDO.getTableName(), e);
            }
        }
    }
    ...
    public static Configuration getConfig() {
        try {
            ...
            throw new com.zz.common.utils.BDException("获取配置文件失败，", e);
        }
    }
