...
import com.zz.common.domain.FileDO;
import com.zz.common.service.FileService;
...
public class FileController extends BaseController {
	...
	R upload(@RequestParam("file") MultipartFile file, HttpServletRequest request) {
		...
		if (sysFileService.save(sysFile) > 0) {
			return R.ok().put("fileName",sysFile.getUrl()).put("fileId",sysFile.getId()).put("fileUrl",imageHost+sysFile.getUrl());
		}
		return R.error();
	}
